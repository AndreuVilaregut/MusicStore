...
class QRScannerActivity1 : Activity() {
        ...
        if (result != null && result.contents != null) {
            ...
            if (guitarraId != null) {
                ...
                if (guitarra != null) {
                    ...
                    val intent = Intent(this, DetallsGuitarra1::class.java)
                    val bundle = Bundle().apply {
                        putInt("ID", guitarra.id)  // Afegir ID de la guitarra
                        ...
                        putInt("UNITATS_ESTOC", guitarra.unitatsEstoc)  // Afegir l'estoc
